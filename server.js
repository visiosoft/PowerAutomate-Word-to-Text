            ...
            if (req.body[0] === 0x50 && req.body[1] === 0x4B) {
                try {
                    ...
                    let canvasContent = COMPANYPOLICYTEMPLATE.CanvasContent1
                        ...
                        .replace('##PREVIOUS_URL##', previousUrl)
